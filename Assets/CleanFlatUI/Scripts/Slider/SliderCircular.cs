...
{  
    public SliderCircular mSliderCircular; //The Slider Circular object.
    void Start()
    {
        //mSliderCircular.Clockwise = true; //Set Slider Circular direction.
        
        mSliderCircular.MinValue = 0; //Set the minimum value of the Slider Circular.
        mSliderCircular.MaxValue = 1; //Set the maximum value of the Slider Circular.
        mSliderCircular.WholeNumbers = false; //Set whether to show the whole numbers of the Slider Circular.
        mSliderCircular.Value = 0.8; //Set the value of the Slider Circular.
        mSliderCircular.HasText = true; //Set whether to show the text value.  
        
        //Add value changed event listener.
        mSliderCircular.OnValueChanged.AddListener(SliderCircularValueChange);
    } 
    public void SliderCircularValueChange(float val)
    {
        Debug.Log("SliderCircularValueChange Current Value is: " + val);
    }       
}
*/
