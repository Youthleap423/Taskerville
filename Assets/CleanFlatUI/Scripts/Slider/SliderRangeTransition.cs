...
{  
    public SliderRangeTransition mSliderRangeTransition; //The Slider Range object.
    void Start()
    {
        mSliderRangeTransition.MinValue = 0; //Set the minimum value of the Slider Range.
        mSliderRangeTransition.MaxValue = 1; //Set the maximum value of the Slider Range.
        mSliderRangeTransition.WholeNumbers = false; //Set whether to show the whole numbers of the Slider Range.
        mSliderRangeTransition.Value1 = 0.2f; //Set the value1 of the Slider Range.
        mSliderRangeTransition.Value2 = 0.8f; //Set the value2 of the Slider Range.
        mSliderRangeTransition.HasText = true; //Set whether to show the text value.      
        
        //Add value changed event listener.
        mSliderRangeTransition.OnValue1Changed.AddListener(SliderRangeValue1Change);    
        mSliderRangeTransition.OnValue2Changed.AddListener(SliderRangeValue2Change);    
    }    
    public void SliderRangeValue1Change(float val)
    {
        Debug.Log("SliderRangeValue1Change Current Value is: " + val);
    }  
    public void SliderRangeValue2Change(float val)
    {
        Debug.Log("SliderRangeValue2Change Current Value is: " + val);
    }       
}
*/
