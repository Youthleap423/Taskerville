...
{  
    public SliderRange mSliderRange; //The Slider Range object.
    void Start()
    {
        mSliderRange.MinValue = 0; //Set the minimum value of the Slider Range.
        mSliderRange.MaxValue = 1; //Set the maximum value of the Slider Range.
        mSliderRange.WholeNumbers = false; //Set whether to show the whole numbers of the Slider Range.
        mSliderRange.Value1 = 0.2f; //Set the value1 of the Slider Range.
        mSliderRange.Value2 = 0.8f; //Set the value2 of the Slider Range.
        mSliderRange.HasText = true; //Set whether to show the text value. 

        //Add value changed event listener.
        mSliderRange.OnValue1Changed.AddListener(SliderRangeValue1Change);    
        mSliderRange.OnValue2Changed.AddListener(SliderRangeValue2Change);      
    }    
