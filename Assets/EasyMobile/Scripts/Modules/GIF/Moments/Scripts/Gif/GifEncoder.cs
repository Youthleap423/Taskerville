...
namespace EM_Moments.Encoder
{
    public class GifEncoder
    {
        ...
        protected void WriteGraphicCtrlExt()
        {
            ...
            // Packed fields
            m_FileStream.WriteByte(System.Convert.ToByte(0 |     // 1:3 reserved
                                                  0 |     // 4:6 disposal
                                                  0 |     // 7   user input - 0 = none
                                                  0));    // 8   transparency flag

            WriteShort(m_FrameDelay); // Delay x 1/100 sec
            m_FileStream.WriteByte(System.Convert.ToByte(0)); // Transparent color index
        ...
        protected void WriteImageDesc()
        {
            ...
            {
                // Specify normal LCT
                m_FileStream.WriteByte(System.Convert.ToByte(0x80 |           // 1 local color table  1=yes
                                                      0 |              // 2 interlace - 0=no
                                                      0 |              // 3 sorted - 0=no
                                                      0 |              // 4-5 reserved
        ...
        protected void WriteLSD()
        {
            ...
            // Packed fields
            m_FileStream.WriteByte(System.Convert.ToByte(0x80 |           // 1   : global color table flag = 1 (gct used)
        ...
        {
            m_FileStream.WriteByte(System.Convert.ToByte(value & 0xff));
            m_FileStream.WriteByte(System.Convert.ToByte((value >> 8) & 0xff));
        }
