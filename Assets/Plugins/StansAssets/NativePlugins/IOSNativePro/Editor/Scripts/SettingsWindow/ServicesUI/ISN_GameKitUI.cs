...
namespace SA.iOS
{
    class ISN_GameKitUI : ISN_ServiceSettingsUI
    {
        ...
        {
            achievement.Identifier = IMGUILayout.TextField(AchievementIdDLabel, achievement.Identifier);
            achievement.Name = IMGUILayout.TextField(AchievementNameLabel, achievement.Name);
        }
    }
}
