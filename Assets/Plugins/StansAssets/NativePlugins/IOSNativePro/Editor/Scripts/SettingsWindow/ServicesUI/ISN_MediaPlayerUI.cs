...
namespace SA.iOS
{
    class ISN_MediaPlayerUI : ISN_ServiceSettingsUI
    {
        ...
        protected override string Description => "Add the ability to find and play songs, audio podcasts, audio books, and more from within your app.";

        protected override Texture2D Icon => EditorAssetDatabase.GetTextureAtPath(ISN_Skin.IconsPath + "MediaPlayer_icon.png");
        ...
        protected override void OnServiceUI()
        {
            ...
            {
                ISN_Settings.Instance.MediaLibraryUsageDescriptionEnabled = IMGUILayout.ToggleFiled("API State", ISN_Settings.Instance.MediaLibraryUsageDescriptionEnabled, IMGUIToggleStyle.ToggleType.EnabledDisabled);
