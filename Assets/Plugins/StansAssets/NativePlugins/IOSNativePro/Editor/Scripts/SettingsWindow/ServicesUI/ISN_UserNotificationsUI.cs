    ...
    class ISN_UserNotificationsUI : ISN_ServiceSettingsUI
    {
        ...
        protected override void OnServiceUI()
        {
            ...
            using (new SA_WindowBlockWithSpace(new GUIContent("Apple Push Notification Service")))
            {
                ...
                {
                    ISD_API.Capability.PushNotifications.Enabled = IMGUILayout.ToggleFiled("API Status", ISD_API.Capability.PushNotifications.Enabled, IMGUIToggleStyle.ToggleType.EnabledDisabled);
                    ISD_API.Capability.PushNotifications.development = IMGUILayout.ToggleFiled("Development Environment", ISD_API.Capability.PushNotifications.development, IMGUIToggleStyle.ToggleType.EnabledDisabled);
                }
            }
        }
