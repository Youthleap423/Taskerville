...
namespace SA.Android.Content.Pm
{
    ...
    public class AN_PackageManager
    {
        ...
        const string k_AndroidClass = "com.stansassets.android.content.pm.AN_PackageManager";
        ...
        public List<AN_ResolveInfo> QueryIntentActivities(AN_Intent intent, int flags = 0)
        {
            ...
            var json = AN_Java.Bridge.CallStatic<string>(k_AndroidClass, "QueryIntentActivities", m_Context, intent, flags);
        ...
        public AN_PackageInfo GetPackageInfo(string packageName, int flags)
        {
            ...
            var json = AN_Java.Bridge.CallStatic<string>(k_AndroidClass, "GetPackageInfo", m_Context, packageName, flags);
        ...
        {
            var instanceId = AN_Java.Bridge.CallStatic<int>(k_AndroidClass, "GetLaunchIntentForPackage", m_Context, packageName);
