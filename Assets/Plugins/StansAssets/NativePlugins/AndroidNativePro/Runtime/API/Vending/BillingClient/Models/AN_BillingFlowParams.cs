...
#pragma warning disable 414
            ...
            [SerializeField]
            string m_ProfileId = string.Empty;
            [SerializeField]
...
#pragma warning restore 414
            ...
            [Obsolete("The SetAccountId is deprecated use SetObfuscatedAccountId instead.")]
            public void SetAccountId(string accountId)
            {
                SetObfuscatedAccountId(accountId);
            }

            [Obsolete("Removed From the google API.")]
            ...
            /// Setting this field requests the user's obfuscated account id to be pass
            /// via <see cref="SetObfuscatedAccountId"/>
            ///
            /// If you pass this value, Google Play can use it to detect irregular activity,
            /// such as many devices making purchases on the same account in a short period of time.
            /// Do not use this field to store any Personally Identifiable Information (PII)
            /// such as emails in cleartext. Attempting to store PII in this field will result
            /// in purchases being blocked. Google Play recommends that you use either
            /// encryption or a one-way hash to generate an obfuscated identifier to send to Google Play.
            ///
            /// You can also retrieve this identifier via the <see cref="AN_Purchase"/> object.
            ///
            ...
            ///
            /// </summary>
            /// <param name="obfuscatedProfileId">Obfuscated ProfileId.</param>
            public void SetObfuscatedProfileId(string obfuscatedProfileId)
            {
                m_ProfileId = obfuscatedProfileId;
            }

            /// <summary>
            /// Specifies the SKU and purchase token that the user is upgrading or downgrading from.
            /// This will disambiguate situations where multiple accounts on the device own the same SKU.
            ///
            /// Mandatory:
            ///  * To replace an old subscription
            /// </summary>
