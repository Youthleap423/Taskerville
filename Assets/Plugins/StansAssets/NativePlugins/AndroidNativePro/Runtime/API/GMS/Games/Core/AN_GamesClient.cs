...
namespace SA.Android.GMS.Games
{
    ...
    {
        const string k_GamesClientJava = "com.stansassets.gms.games.AN_GamesClient";
        ...
        {
            AN_Java.Bridge.CallStatic(k_GamesClientJava, "SetViewForPopups", HashCode, activity);
        }
        ...
        {
            AN_Java.Bridge.CallStatic(k_GamesClientJava, "SetGravityForPopups", HashCode, gravity);
        }
        ...
        {
            AN_Java.Bridge.CallStaticWithCallback(k_GamesClientJava, "GetSettingsIntent", callback, HashCode);
        }
