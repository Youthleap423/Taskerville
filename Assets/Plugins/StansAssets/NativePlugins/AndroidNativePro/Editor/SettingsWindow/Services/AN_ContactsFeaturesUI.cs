...
namespace SA.Android.Editor
{
    class AN_ContactsFeaturesUI : AN_ServiceSettingsUI
    {
        ...
        protected override string Description => "Powerful and flexible Android component that manages the device's central repository of data about people.";

        protected override Texture2D Icon => AN_Skin.GetIcon("android_contacts.png");

        protected override SA_iAPIResolver Resolver => AN_Preprocessor.GetResolver<AN_ContactsResolver>();
