...
namespace SA.Android.Editor
{
    class AN_SocialFeaturesUI : AN_ServiceSettingsUI
    {
        ...
        protected override string Description => "Implementing an effective and user friendly share actions in your app.";

        protected override Texture2D Icon => AN_Skin.GetIcon("android_social.png");

        protected override SA_iAPIResolver Resolver => AN_Preprocessor.GetResolver<AN_SocialResolver>();

        protected override void OnServiceUI()
        {
            AN_SettingsTab.DrawStorageSettings();
        }
    }
}
