...
namespace SA.Android.Editor
{
    class AN_CameraAndGalleryFeaturesUI : AN_ServiceSettingsUI
    {
        ...
        protected override string Description => "A simplifayed way to get images or video from camera or gallery.";

        protected override Texture2D Icon => AN_Skin.GetIcon("android_gallery.png");

        protected override SA_iAPIResolver Resolver => AN_Preprocessor.GetResolver<AN_CameraAndGalleryResolver>();
