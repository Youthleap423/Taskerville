...
namespace SA.Android.Editor
{
    static class AN_TestManager
    {
        ...
        public static void ApplyExampleConfig()
        {
            ...
            AN_GooglePlayResources.OverrideGamesIds(GAMES_IDS);
        }

        public static void OpenTestScene()
        {
            EditorSceneManager.OpenScene(AN_Settings.AndroidTestScenePath, OpenSceneMode.Single);
        }
        ...
        public static void MakeTestBuild()
        {
            ...
            playerOptions.scenes = new[] { AN_Settings.AndroidTestScenePath };
